...
==> web_1: Box 'chef/centos-6.5' could not be found. Attempting to find and inst
all...
...
==> web_1: Adding box 'chef/centos-6.5' (v1.0.0) for provider: virtualbox
    web_1: Downloading: https://vagrantcloud.com/chef/centos-6.5/version/1/provi
der/virtualbox.box
    web_1: Progress: 4% (Rate: 3203k/s, Estimated time remaining: 0:02:44))
```
